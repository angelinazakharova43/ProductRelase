    ...
    public partial class AddForm : Form
    {
        ...
        private void BtnAdd_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    TextBox txtBox = (TextBox)Controls[$"txt{col.ColumnName}"];
                    object val = txtBox.Text;
                    if (col.DataType == typeof(int))
                        ...
                        if (decimal.TryParse(txtBox.Text, out decimal intVal)) val = intVal;
                        else
                        {
                ...
                if (rowAff > 0) MessageBox.Show("Данные успешно добавлены", "Данные добавлены",
                    MessageBoxButtons.OK, MessageBoxIcon.Information);
                else MessageBox.Show("Не удалось добавить данные", "Данные не добавлены",
                    MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
            catch(Exception ex)
